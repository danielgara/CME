...
<form class="well form-search" method="post" action="{$gvar.l_admin_control_component}?option=save" enctype="multipart/form-data">
<legend>Edit component <span style="font-size:14px">(Fields marked with * are required)</span></legend>
<fieldset>
