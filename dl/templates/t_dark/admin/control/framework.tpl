...
<form class="well form-search" onreset="form_reset(this);return false;" method="post" action="{$gvar.l_admin_control_framework}?option=add" enctype="multipart/form-data"> 
